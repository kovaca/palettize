...
| `alpha_format` | `str` | `"int"` | Alpha format: `"int"` (0-255) or `"float"` (0-1) |

### Output Formats

| Format | Description | Example Output |
|--------|-------------|----------------|
| `css` | CSS rgba() format (default) | `rgba(68, 1, 84, 255)` |
| `tuple` | Python tuple format | `(68, 1, 84, 255)` |
| `json` | JSON array of arrays | `[[68, 1, 84, 255], ...]` |

### Alpha Formats

| Format | Description | Example |
|--------|-------------|---------|
| `int` | Integer 0-255 (default) | `rgba(68, 1, 84, 255)` |
| `float` | Float 0-1 | `rgba(68, 1, 84, 1.0)` |
...
# JSON array format
palettize create viridis -f rgba --steps 5 -O output_format=json

# CSS with float alpha (standard CSS format)
palettize create viridis -f rgba --steps 5 -O alpha_format=float

# Python tuple format
palettize create viridis -f rgba --steps 5 -O output_format=tuple
```
...
# [[68, 1, 84, 255], [59, 82, 139, 255], ...]

# CSS format with float alpha
css_output = exporter.export(
    cmap, scaler, 0, 1,
    options={"num_colors": 5, "alpha_format": "float"}
)
# rgba(68, 1, 84, 1.0)
# rgba(59, 82, 139, 1.0)
# ...
