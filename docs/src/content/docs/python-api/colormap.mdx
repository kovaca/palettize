...
hsl = cmap.get_color(0.5, output_format="hsl_tuple")  # (178.0, 62.8, 34.8)
...
| `output_space` | `str` | `"srgb"` | Color space: `"srgb"` or `"display-p3"` |

#### Output Formats

| Format | Return Type | Example | Use Case |
|--------|-------------|---------|----------|
| `hex` | `str` | `"#21918c"` | CSS, general purpose |
| `rgb_tuple` | `tuple[int, ...]` | `(33, 145, 140)` | Image processing |
| `rgba_tuple` | `tuple[int, ...]` | `(33, 145, 140, 255)` | Image processing with alpha |
...
| `hsl_tuple` | `tuple[float, ...]` | `(178.0, 62.8, 34.8)` | Color manipulation |
